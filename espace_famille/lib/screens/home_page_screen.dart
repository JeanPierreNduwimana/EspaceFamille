        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(S.of(context).homePageSectionTitle1,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Colors.grey
                        .withOpacity(0.2), // Couleur de l'ombre avec opacité
                    spreadRadius: isDarkMode ? 1 : 4, // Rayonnement de l'ombre
                    blurRadius: 6, // Rayon du flou de l'ombre
                    offset: isDarkMode
                        ? const Offset(1, 1)
                        : const Offset(
                            3, 3), // Décalage horizontal et vertical de l'ombre
                  ),
                ],
              ),
              child: Column(
                                              ...
                                              child: ColorFiltered(
                                                colorFilter: ColorFilter.mode(
                                                  Colors.black.withOpacity(
                                                      0.5), // Adjust the opacity
                                                  BlendMode
                                                      .darken, // Ensures the opacity blends with the image
                                                ),
                                                child: Image.asset(
                                                  "assets/images/naruto.jpg",
                                                  fit: BoxFit.cover,
            ...
            Container(
              ...
              padding: const EdgeInsets.all(12.0),
              child: Text(S.of(context).homePageSectionTitle2,
                  style: const TextStyle(
                      fontSize: 28, fontWeight: FontWeight.w600)),
            ),
            Container(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: Colors.grey
                          .withOpacity(0.2), // Couleur de l'ombre avec opacité
                      spreadRadius:
                          isDarkMode ? 1 : 4, // Rayonnement de l'ombre
                      blurRadius: 6, // Rayon du flou de l'ombre
                      offset: isDarkMode
                          ? const Offset(1, 1)
                          : const Offset(3,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: ElevatedButton(
                                          ...
                                          onPressed: () {
                                            Navigator.pushNamed(
                                                context, '/liste_epicerie');
                                          },
                                          child: Text(
                                              S.of(context).buttonSeeMore)),
                                    ),
                                  ],
                                ),
                              ],
            ...
            Container(
              margin: const EdgeInsets.only(top: 32),
              padding: const EdgeInsets.all(12.0),
              child: Text(S.of(context).homePageSectionTitle3,
                  style: const TextStyle(
                      fontSize: 28, fontWeight: FontWeight.w600)),
            ),
            SizedBox(
            ...
            Container(
              margin: const EdgeInsets.only(top: 32),
              padding: const EdgeInsets.all(12.0),
              child: Text(S.of(context).homePageSectionTitle4,
                  style: const TextStyle(
                      fontSize: 28, fontWeight: FontWeight.w600)),
            ),
            Container(
            ...
            Container(
              margin: const EdgeInsets.only(top: 32),
              padding: const EdgeInsets.all(12.0),
              child: Text(S.of(context).homePageSectionTitle5,
                  style: const TextStyle(
                      fontSize: 28, fontWeight: FontWeight.w600)),
            ),
            Container(
