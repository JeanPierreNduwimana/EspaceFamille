...
class MemberTasksRatingsScreen extends StatefulWidget {
  const MemberTasksRatingsScreen({super.key});

  @override
  State<MemberTasksRatingsScreen> createState() =>
      _MemberTasksRatingsScreenState();
}

double value = 3.0;

class _MemberTasksRatingsScreenState extends State<MemberTasksRatingsScreen> {
  @override
  void initState() {
    super.initState();
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return Container(
              // Contient les element de chaque listtile
              margin: const EdgeInsets.all(8),
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                Text(
                                  'ce que je pense de ca ce que je pense de ca ce que je pense de ca ce que je pense de ca ce que je pense de ca ce que je pense de ca',
