              ...
              ? Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 32),
                      Text(S.of(context).groceriePageTitle,
                          textAlign: TextAlign.center,
                          style: const TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 14)),
                      Text(S.of(context).groceriePageSubTitle,
                          textAlign: TextAlign.center,
              ...
              : Dismissible(
                    ...
                    if (direction == DismissDirection.startToEnd) {
                      ...
                      if (food != null) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            ...
                            content: Text(groceryList[index].isPurchased
                                ? 'Cet aliment a été acheté : ${groceryList[index].name}'
                      ...
                      bool? result = await _designService.dialogYesorNo(
                          context, 'Supprimer cette aliment');
                  ...
                  child: GestureDetector(
                    ...
                    child: Card(
                      ...
                      color: groceryList[index].isPurchased
                          ? (isDarkMode
                              ? Colors.black
