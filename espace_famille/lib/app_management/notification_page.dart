...
class _NotificationsPageState extends State<NotificationsPage> {
  final List<Map<String, dynamic>> notifications = [
    ...
    },
    {
      ...
      'description': 'Une nouvelle mise à jour est disponible pour votre application.',
              ...
              return Dismissible(
                ...
                confirmDismiss: (direction)async{
                  if(notification['important']){
                    bool? result = await _designService.dialogYesorNo(context, 'Notification importante! \n Le supprimer?');
                    if(result != null){
                      return result;
                    }
                  }else{
