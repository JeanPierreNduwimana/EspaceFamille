...
class _CommentairesAnnonceState extends State<CommentairesAnnonce> {
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    ...
                    offset: const Offset(
                        2, 2), // Décalage horizontal et vertical de l'ombre
                  ),
                ],
                border: !isDarkMode
                  ...
                  GestureDetector(
                    onTap: () {
                      _designService.dialogAfficherImage(
                          context, 'assets/images/bird.png');
                    },
                    child: SizedBox(
                        height: 60,
                        width: 60,
              ...
              child: Column(
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        '${widget.annonce.commentaires.length} Commentaires',
                  ...
                  Expanded(
                    child: ListView.builder(
                        shrinkWrap: true,
                        itemCount: widget.annonce.commentaires.length,
                          ...
                          return Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    child: widget.annonce.commentaires[ii]
                                            .afficheSousCommentaire
                                        ? const Text('Cacher les commentaires')
                                        : const Text(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          FormController
                                              .controllercommentRepondre
                                              .text = '';
                                          _designService
                                              .dialogRepondreCommentaire(
                                                  context);
                                        },
                              ...
                              ListView.builder(
                                  ...
                                  itemCount: widget.annonce.commentaires[ii]
                                      .commentaires.length,
                                  itemBuilder: (BuildContext context, int i) {
                                    return widget.annonce.commentaires[ii]
                                            .afficheSousCommentaire
                                        ? Row(
                                            children: [
                                              const SizedBox(
  ...
  void afficheSousCommentaire(int index) {
    setState(() {
      widget.annonce.commentaires[index].afficheSousCommentaire =
          !widget.annonce.commentaires[index].afficheSousCommentaire;
    });
  }
}
